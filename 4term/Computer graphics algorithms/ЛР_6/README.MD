...
# ЗАДАНИЕ К ЛАБОРАТОРНОЙ РАБОТЕ № 3.2
...
namespace lab3
{
    public partial class Form1 : Form
    {
        ...
        int X_min = -15, Y_min = -15, X_max = 15, Y_max = 15;
        ...
        private void functionCalculation()
        {
            ...
            int n = (int)((X_max - X_min) / 0.1) + 1;
            GrapValuesArray = new float[n, 2];
        ...
        private void Draw()
        {
            ...
            PrintText2D(devX * Mcoord_X + 0.2f, (float)ScreenH - devY * Mcoord_Y + 0.4f, "[ x: " + (devX * Mcoord_X + X_min).ToString() + " ; y: " + ((float)ScreenH - devY * Mcoord_Y + Y_min).ToString() + "]");
            ...
            Gl.glVertex2d(lineX, -Y_min);
            Gl.glVertex2d(lineX, lineY);
            Gl.glVertex2d(-X_min, lineY);
            Gl.glVertex2d(lineX, lineY);
